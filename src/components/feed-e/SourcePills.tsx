    ...
    <div className="flex items-center gap-1.5">
      {links.map(({ label, href }) => (
        <a
          ...
          className="inline-flex items-center gap-1 rounded-md border border-gray-200/80 bg-gray-50/80 px-2 py-0.5 text-[10px] font-mono text-gray-500 transition-all hover:border-teal-300 hover:text-teal-700 hover:bg-teal-50/50 hover:shadow-[0_0_8px_rgba(20,184,166,0.08)]"
        >
